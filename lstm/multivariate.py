...
from prep_data import split_sequences_multivariate, split_sequences_multiparallel
...
inputs2, outputs2 = split_sequences_multiparallel(dataset, n_steps)
...
def multiparallel(inputs2, outputs2, n_steps, in_seq1, in_seq2, batch_size, num_epochs, type="vanilla"):
  # the dataset knows the number of features, e.g. 2
  n_features = inputs2.shape[2]
  # define model
  model = Sequential()
  if type == "vanilla":
    model.add(LSTM(batch_size, activation='relu', input_shape=(n_steps, n_features)))
  ...
  model.compile(optimizer='adam', loss='mse')
  # fit model
  model.fit(inputs2, outputs2, epochs=num_epochs, verbose=0)
  # demonstrate prediction
...
print(multiparallel(inputs2, outputs2, n_steps, in_seq1, in_seq2, batch_size, num_epochs, type="vanilla"))
print(multiparallel(inputs2, outputs2, n_steps, in_seq1, in_seq2, batch_size, num_epochs, type="stacked"))
print(multiparallel(inputs2, outputs2, n_steps, in_seq1, in_seq2, batch_size, num_epochs, type="bidirectional"))
